        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Add a branch</h3>
                </div>
            </div>
            <div class="row">
			...
			Enter Branch to be added:
			<input type ="text" name = "branchName" placeholder="Enter name">
		    <input type ="text" name = "branchAddress" placeholder="Enter address"><br />
