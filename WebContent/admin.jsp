        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="bookorauthor.jsp" class="portfolio-link">
                    ...
                    <div class="portfolio-caption">
                        <h4>Add/Update/Delete Books And Authors</h4>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="adminPublisher.jsp" class="portfolio-link">
                        <div class="portfolio-hover">
                            <div class="portfolio-hover-content">
                                <i class="fa fa-plus fa-3x"></i>
                            </div>
                    ...
                    <div class="portfolio-caption">
                        <h4>Add/Update/Delete Publishers</h4>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="adminbranches.jsp" class="portfolio-link">
                        <div class="portfolio-hover">
                            <div class="portfolio-hover-content">
                                <i class="fa fa-plus fa-3x"></i>
                            </div>
                    ...
                    <div class="portfolio-caption">
                        <h4>Add/Update/Delete Library Branches</h4>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="adminBorrower.jsp" class="portfolio-link">
                        <div class="portfolio-hover">
                            <div class="portfolio-hover-content">
                                <i class="fa fa-plus fa-3x"></i>
                            </div>
                    ...
                    <div class="portfolio-caption">
                        <h4>Add/Update/Delete Borrowers</h4>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="adminOverride.jsp" class="portfolio-link" data-target="#override" data-toggle="modal">
                        <div class="portfolio-hover">
                            <div class="portfolio-hover-content">
                                <i class="fa fa-plus fa-3x"></i>
                            </div>
                    ...
                    <div class="portfolio-caption">
                        <h4>Override Due Date for a bookloan</h4>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a class="portfolio-link" data-toggle="modal" data-target="#getloans">
                        <div class="portfolio-hover">
                            <div class="portfolio-hover-content">
                                <i class="fa fa-plus fa-3x"></i>
                            </div>
         ...
         <div class="modal fade bs-example-modal-lg" tabindex="-1" id=override role="dialog" aria-labelledby="mySmallModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" id=getloans role="dialog" aria-labelledby="mySmallModalLabel">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
