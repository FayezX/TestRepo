        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Choose Between Book or Author</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="book.jsp" class="portfolio-link">
                    ...
                    <div class="portfolio-caption">
                        <h4>Add/Update/Delete Books</h4>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="author.jsp" class="portfolio-link">
                        <div class="portfolio-hover">
                            <div class="portfolio-hover-content">
                                <i class="fa fa-plus fa-3x"></i>
                            </div>
                    ...
                    <div class="portfolio-caption">
                        <h4>Add/Update/Delete Authors</h4>
                    </div>
            </div>
        </div>
    </section>
